...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:008]).

![Создание программы readfile.c](image/8.png){#fig:001 width=70%}
...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:009]).

![Компиляция и выполнение программы readfile.c](image/9.png){#fig:001 width=70%}
...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:010]).

![Смена владельца файла readfile.c](image/10.png){#fig:001 width=70%}

16. Проверьте, что пользователь guest не может прочитать файл readfile.c.

Выполнение этого пункта вы можете видеть ниже (рис. [@fig:011]).

![Невозможность прочитать файл readfile.c](image/11.png){#fig:001 width=70%}
...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:012]). Как можно заметить, атрибут установлен, потому что в конце стоит буква t.
...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:014]). 

![Попытка дозаписать в файл](image/14.png){#fig:001 width=70%}

6. Проверьте содержимое файла командой `cat /tmp/file01.txt`

Выполнение этого пункта вы можете видеть ниже (рис. [@fig:015]). 
...
Выполнение этого пункта вы можете видеть ниже (рис. [@fig:016]). 
